...
public class QueryPersonCouponController implements Controller
{
    @Override
    public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception
    {
        ...
        Coupon coupon = couponService.queryPersonCoupon(token, uuid, keyID);
        json = JSONObject.fromObject(coupon);
        stream.write(json.toString().getBytes("UTF-8"));
