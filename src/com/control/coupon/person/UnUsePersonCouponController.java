...
public class UnUsePersonCouponController implements Controller
{
    @Override
    public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception
    {
        ...
        String couponUUID = request.getParameter("uuid");
        CouponServiceInterface conponService = new CouponService();
        int result = conponService.unUsePersonCoupn(token, couponUUID, keyID);
