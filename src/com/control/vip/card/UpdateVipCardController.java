...
public class UpdateVipCardController implements Controller
{
    ...
    public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception
    {
        ...
        if ((!UntilNum.isNumber(discount)) || !UntilNum.isNumber(level) || !UntilNum.isNumber(id))
        {
        ...
        if (null != multipartFile)
        {
            ...
            if (null != fileName && (!("".equals(fileName))))
            {
                ...
                result = service.updatePic(token, id, attacheFile, keyID);
            }

        }

        result = service.updateVipCard(token, vipCard);
