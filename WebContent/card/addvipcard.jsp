	...
	<div id="main">
		...
		<div id="content">
			...
			<div class="wrapper">
				<div class="aside">
					<ul class="nav001">
						<li><a class="current">创建会员卡</a></li>
						<li>
							<a href="/vip/card/query.action">查询会员卡</a>
						</li>
					</ul>
					<div class="box">
						<div class="inner">
				...
				<div class="mainContent">
					...
					<div class="wrapper">
						<form id="addvip" action="/vip/card/create.action" method="post"
							...
							<!-- 										<label>会员卡类型</label> -->
							<!-- 										<div class="ui left labeled input"> -->
							<!-- 											<select name="type" id="categoryS"> -->
							<!-- 											<option value="discountcard">折扣卡</option> -->
							<!-- 											<option value="storedvaluecard">储值卡</option> -->
							<!-- 											<option value="blendcard">折扣储值卡</option> -->
							...
							<div class="field">
								<label>级别</label>
								<div class="ui left labeled input">
									<input id="level" name="level" type="text" placeholder="请使用1-100之间的整数，数值越大，级别越高。"
							...
							<div class="field">
								<label>折扣</label>
								<div class="ui left labeled input">
									<input id="discount" name="discount" type="text" placeholder="请使用小数，如95折则输入0.95"
